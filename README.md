...
1. [Task 1: Chatbot with Rule-Based Responses](PROJECTS/CHATBOT_WITH_RULE_BASED_RESPONSES)
2. [Task 2: Tic-Tac-Toe AI](PROJECTS/TIC-TAC-TOE AI)
...
- Identifies user queries and provides appropriate responses.
...
- Ensures the AI player is unbeatable.
...
- Generates captions using RNN or transformer-based models.
...
- Optionally adds face recognition using Siamese networks or ArcFace.
